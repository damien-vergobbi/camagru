...
<head>
    ...
    <meta property="og:image" content="http://<?= getenv('SRVR_IP') ?>:<?= getenv('SRVR_PORT') ?>/app/media/icon-user.png" />
    <meta property="og:url" content="http://<?= getenv('SRVR_IP') ?>:<?= getenv('SRVR_PORT') ?>/public/post.php" />
    ...
    <div class="infinite-wrapper">
      ...
      <main>
        ...
        <div id="post" class="item-div hidden">
          ...
          <div id="share-div">
            <p>Share this post</p>
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('http://' . getenv('SRVR_IP') . ':' . getenv('SRVR_PORT') . $_SERVER['REQUEST_URI']); ?>" target="_blank">
              <img src="../app/media/logo-facebook.svg" alt="Facebook" height="20">
            </a>

            <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode('http://' . getenv('SRVR_IP') . ':' . getenv('SRVR_PORT') . $_SERVER['REQUEST_URI']); ?>&text=Check%20this%20post%20on%20Camagru" target="_blank">
              <img src="../app/media/logo-x.avif" alt="Twitter" height="20">
            </a>

            <a href="whatsapp://send?text=<?php echo urlencode('Check this post on Camagru: http://' . getenv('SRVR_IP') . ':' . getenv('SRVR_PORT') . $_SERVER['REQUEST_URI']); ?>" target="_blank">
              <img src="../app/media/logo-whatsapp.webp" alt="Whatsapp" height="20">
            </a>

            <a href="mailto:?subject=Camagru Share&body=See this post on Camagru : <?php echo urlencode('http://' . getenv('SRVR_IP') . ':' . getenv('SRVR_PORT') . $_SERVER['REQUEST_URI']); ?>" target="_blank">
